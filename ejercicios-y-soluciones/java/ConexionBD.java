...
/* 
 public void conectarAccess(String nombreBD, String usuario, String clave) {
  ...
  /**
   * Realiza la coenxion a una BD MySQL.  Debe recordar anadir al proyecto el archivo '.jar' de MySQL.
   ...
   * @param nombreCampoNuevo  Campo nuevo que reemplazara al campo actual.
   */
